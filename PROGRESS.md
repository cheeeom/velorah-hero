...
> 基准：`0a63669`（v1.4.0，2026-09-11 修复批次）。

## 当前状态速览
- 🟢 **本地已修复并提交（v1.4.0）**，`tsc` 零错误、oxlint 零警告、`npm run build` 通过
- 🟡 **尚未推送到 GitHub**：v1.4.0 的代码、6 个 tag、以及自动部署工作流都还在本地
...
- [ ] SEO：`meta description`、Open Graph 分享卡片、JSON-LD、`sitemap.xml`/`robots.txt`、每页独立 `title`
...
### 待确认（需要老板拍板）
- [ ] 英文名 `Chee Eom` 与"严其"不是拼音关系 —— 是品牌网名还是笔误？决定 SEO 铺哪个关键词
- [ ] 是否推送 v1.4.0 到 GitHub（含 tag 与 Actions 工作流）
